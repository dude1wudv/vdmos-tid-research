...
import { needsShell, resolveLatestCodexCommand, shellCommand } from "./codexCli.js";
...
export class AppServerClient extends EventEmitter {
  ...
  async connect() {
    ...
    const command = this.options.command ?? await resolveLatestCodexCommand();
    ...
    this.#child = needsShell(command) ? spawn(shellCommand(command, args), { ...spawnOptions, shell: true }) : spawn(command, args, spawnOptions);
