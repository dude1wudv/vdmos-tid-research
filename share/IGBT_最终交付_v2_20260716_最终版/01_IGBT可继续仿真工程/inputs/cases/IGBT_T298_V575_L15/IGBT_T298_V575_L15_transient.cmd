File {
  ...
  Plot = "IGBT_T298_V575_L15_tr"
  Current = "IGBT_T298_V575_L15_tr.plt"
  Output = "IGBT_T298_V575_L15_tr.log"
}
Electrode {
  { Name="Gate" Voltage=0 }
...
Solve {
  Load(FilePrefix="IGBT_T298_V575_L15_restart")
  Plot(FilePrefix="IGBT_T298_V575_L15_tr_pre" NoOverwrite)
  NewCurrentPrefix="IGBT_T298_V575_L15_tr_transient_"
  ...
  Plot(FilePrefix="IGBT_T298_V575_L15_tr_audit_100p5ps" NoOverwrite)
  ...
  Plot(FilePrefix="IGBT_T298_V575_L15_tr_audit_101ps" NoOverwrite)
  ...
  Plot(FilePrefix="IGBT_T298_V575_L15_tr_audit_102ps" NoOverwrite)
  ...
  Plot(FilePrefix="IGBT_T298_V575_L15_tr_audit_103ps" NoOverwrite)
  ...
  Plot(FilePrefix="IGBT_T298_V575_L15_tr_audit_104ps" NoOverwrite)
  ...
  Plot(FilePrefix="IGBT_T298_V575_L15_tr_audit_106ps" NoOverwrite)
  ...
  Plot(FilePrefix="IGBT_T298_V575_L15_tr_audit_108ps" NoOverwrite)
  Transient(
    InitialTime=1.08e-10 FinalTime=2.1e-9
    InitialStep=2e-13 Increment=1.4 Decrement=2
    MinStep=1e-17 MaxStep=1e-10
  ) { Coupled { Poisson Electron Hole Temperature } }
  Plot(FilePrefix="IGBT_T298_V575_L15_tr_at2p1ns" NoOverwrite)
}
