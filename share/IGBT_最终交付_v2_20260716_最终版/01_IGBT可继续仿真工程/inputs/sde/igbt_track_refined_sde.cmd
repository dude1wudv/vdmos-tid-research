...
;----------------------------------------------------------------------
; Saving BND file
(sdeio:save-tdr-bnd (get-body-list) "igbt_track_refined_bnd.tdr")

; Save CMD file
(sdedr:write-cmd-file "igbt_track_refined_msh.cmd")
(system:command "snmesh -offset igbt_track_refined_msh")
