...
param(
    ...
    [string] $LocalRunRoot = '',
    [string] $RemoteRunRoot = '<REMOTE_RUN_ROOT>',
    ...
    [string] $VmUserHost = '<AUTHORIZED_VM>',
    [string] $SentaurusRoot = '<SENTAURUS_ROOT>',
