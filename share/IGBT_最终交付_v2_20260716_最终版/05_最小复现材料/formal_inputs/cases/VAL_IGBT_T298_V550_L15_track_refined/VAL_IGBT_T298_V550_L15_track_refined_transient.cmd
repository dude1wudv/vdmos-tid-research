File {
  Grid = "igbt_track_refined_msh.tdr"
  Parameters = "sdevice.par"
  Plot = "VAL_IGBT_T298_V550_L15_track_refined_tr"
  Current = "VAL_IGBT_T298_V550_L15_track_refined_tr.plt"
  Output = "VAL_IGBT_T298_V550_L15_track_refined_tr.log"
}
Electrode {
  { Name="Gate" Voltage=0 }
...
Solve {
  Load(FilePrefix="VAL_IGBT_T298_V550_L15_track_refined_restart")
  Plot(FilePrefix="VAL_IGBT_T298_V550_L15_track_refined_tr_pre" NoOverwrite)
  NewCurrentPrefix="VAL_IGBT_T298_V550_L15_track_refined_tr_transient_"
  ...
  Plot(FilePrefix="VAL_IGBT_T298_V550_L15_track_refined_tr_audit_100p5ps" NoOverwrite)
  ...
  Plot(FilePrefix="VAL_IGBT_T298_V550_L15_track_refined_tr_audit_101ps" NoOverwrite)
  ...
  Plot(FilePrefix="VAL_IGBT_T298_V550_L15_track_refined_tr_audit_102ps" NoOverwrite)
  ...
  Plot(FilePrefix="VAL_IGBT_T298_V550_L15_track_refined_tr_audit_103ps" NoOverwrite)
  ...
  Plot(FilePrefix="VAL_IGBT_T298_V550_L15_track_refined_tr_audit_104ps" NoOverwrite)
  ...
  Plot(FilePrefix="VAL_IGBT_T298_V550_L15_track_refined_tr_audit_106ps" NoOverwrite)
  ...
  Plot(FilePrefix="VAL_IGBT_T298_V550_L15_track_refined_tr_audit_108ps" NoOverwrite)
  Transient(
    InitialTime=1.08e-10 FinalTime=2.1e-9
    InitialStep=2e-13 Increment=1.4 Decrement=2
    MinStep=1e-17 MaxStep=1e-10
  ) { Coupled { Poisson Electron Hole Temperature } }
  Plot(FilePrefix="VAL_IGBT_T298_V550_L15_track_refined_tr_at2p1ns" NoOverwrite)
}
